 ...
 * @param {number[][]} points
 * @return {number}
 * 以每一个点为基准，算出剩余点到此点的距离，再对距离相等的点的个数进行排列组合
 * 
 */
...
/**
 * 超时算法，太多的循环遍历操作
 * 经检查发现，dis数组多于，push每一项之后，后面又用for循环遍历每一项
 */
